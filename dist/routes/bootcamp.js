...
//Uplaod image route
router.route('/:id/photo').put(guard_1.protect, bootcamps_1.bootcampPhotoUpload);
...
router
    ...
    .post(guard_1.protect, bootcamps_1.createBootcamp);
router.route('/radius/:zipcode/:distance').get(bootcamps_1.getBootcampsInRadius);
router
    .route('/:id')
    .get(bootcamps_1.getBootcamp)
    .delete(guard_1.protect, bootcamps_1.deleteBootcamp)
    .put(guard_1.protect, bootcamps_1.updateBootcamp);
